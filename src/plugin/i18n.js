...
const messages = {
    "en": {
        ...
        GardenerMonth: "Our awesome gardener of this month is ...",
        ...
        CommP1: "Ritsuko, a learning gardener / a learning nurse. Here for fun, joy and inspiration with the garden community.",
        CommP2: "Edith, flower lover and software developer, here to grow plants and spirituality.",
        ...
        Pic8: "Fire ritual",
        Pic9: "Wood upcycling bench",
        Pic10: "Pastatafel piadina workshop",
        Pic11: "Flower power",
        ...
        Pic20: "The owls are not what they seem",
        ...
        ZH: "Zuhause - Zuhause e.V. is a diverse collective of artists. The Vollguter Gemeinschaftsgarten was initiated by Zuhause e.V. in 2017.  ",
        ...
        FriendsDesc: "We join forces with other great initiatives that have like-minded visions. Together we aim to realize communities, greener cities and flourishing societies as we envision them!",
        EventDesc: "We usually meet on Saturday afternoons in VGG to take care of the garden, fix and build things and hang out together. Contact us beforehand and come and join us. For other events check out our facebook page. Come and join us!",
    ...
    "de": {
        ...
        CommDesc: "Im Garten sind eine Vielzahl unterschiedlicher Menschen aktiv. Jede und jeder kann die eigenen Ideen, Interessen und Fertigkeiten einbringen. Neben den Aktiven, besuchen viele Nachbar:innen den Garten regelmäßig. Der Garten ist offen für alle, die respektvoll mit dem Ort und den Mitmenschen umgehen. Wir sind Gärtner:innen, Gartenaktivist:innen, Partybienen mit unterschiedlichen Hintergründen, Kulturen, Geschlechtern und Begabungen.",
        CommP1: "Ritsuko, eine lernende Gärtnerin / eine lernende Krankenschwester. Hier für Spaß, Freude und Inspiration mit der Gartengemeinschaft.",
        ...
        Pic42: "Garten Fest",
        PartnerDesc: "Vollguter Gemeinschaftsgarten hat einige Partner:innen mit denen wir zusammen arbeiten und die uns unterstützen:  ",
        ...
        Covid: "Covid-19",
        GeneralInfoDesc: "Damit wir alle gesund bleiben, haltet in der Öffentlichkeit bitte einen Mindestabstand von 2 Metern zu Personen ein, die nicht in einem Haushalt mit euch wohnen. Wenn ihr in Parks oder anderen Grünflächen sitzt, müsst ihr einen Abstand von 5 Metern (das sind ungefähr 16,5 Fuß) zu anderen Personen einhalten.",
    ...
    "jp": {
        ...
        GardenerMonth: "私たちが選ぶ今月のベストオブガーデンは…...",
